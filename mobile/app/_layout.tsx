  ...
  return (
    <ThemeProvider value={colorScheme === 'dark' ? DarkTheme : DefaultTheme}>
      <Stack>
        ...
        <Stack.Screen name="exercise-data" options={{ headerShown: false }} />
        <Stack.Screen name="view-photo" options={{ headerShown: false }} />
        <Stack.Screen name="log-meal" options={{ headerShown: false }} />
        <Stack.Screen name="meal-data" options={{ headerShown: false }} />
